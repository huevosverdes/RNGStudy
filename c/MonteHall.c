...
int revealDoor(RNG31_Uniform *urng, int porscheDoor, int selectedDoor);
int followStrategy(Strategy strategy, int selectedDoor, int revealedDoor);
int openDoor(RNG31_Uniform *urng, Strategy strategy);
void openDoors(RNG31_Uniform *urng, Strategy strategy, int roundCount, int *totalRounds, int *totalPorsches);

void openDoorInteractive(RNG31_Uniform *urng);
void openLotsOfDoors(RNG31_Uniform *urng);
...
int revealDoor(RNG31_Uniform *urng, int porscheDoor, int selectedDoor)
{
    ...
    case 1:
        switch(porscheDoor) {
        case 1: revealedDoor = rng31Uniform_coinFlip(urng) ? 2 : 3; break;
    ...
    case 2:
        ...
        case 2: revealedDoor = rng31Uniform_coinFlip(urng) ? 1 : 3; break;
    ...
    case 3:
        ...
        case 3: revealedDoor = rng31Uniform_coinFlip(urng) ? 1 : 2; break;
        };
        break;
    };
...
int openDoor(RNG31_Uniform *urng, Strategy strategy)
{
    int porscheDoor = rng31Uniform_next(urng, 1, 4);
    int selectedDoor_round1 = rng31Uniform_next(urng, 1, 4);
...
void openDoorInteractive(RNG31_Uniform *urng)
{
    ...
    printf("You point %s at door %d.\n", adjectives[rng31Uniform_next(urng, 0, 6)], selectedDoor_round1);
    fflush(stdout);
